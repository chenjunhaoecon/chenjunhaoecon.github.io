...
<div class="row">
  ...
  <div class="column right" style="background-color:transparent;">
    <h2></h2> <!--column title -->
    <p>Welcome! I am an assistant professor at Dongbei University of Finance & Economics in Dalian. I study applied microeconomics with a focus on formal and social institutions, covering topics in charitable giving, policy diffusion, and statistical manipulation. My empirical research uses textual methods to analyze unstructured data. I received my PhD from Boston University in 2024.</p>
